...
require_once('cocoast_dynamic_report_explorer.php'); // provides updated who filter
 ...
 * @subpackage PrebuiltForms
 */
class iform_cocoast_verification_5 {
   ...
   */
  public static function get_cocoast_verification_5_definition() {
    return array(
      'title'=>'Cocoast Verification 5',
...
idlist=';
  ...
  private static function report_filter_panel($args, $readAuth) {
    $options = array(
      ...
      'linkToMapDiv'=>'map',
      'filter-quality'=>'P',
      'generateFilterListCallback' => array('iform_cocoast_verification_5', 'generateFilterListCallback')
    );
